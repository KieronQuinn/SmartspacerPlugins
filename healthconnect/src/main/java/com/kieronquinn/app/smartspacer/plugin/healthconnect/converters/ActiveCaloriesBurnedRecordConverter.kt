...
object ActiveCaloriesBurnedRecordConverter: DataTypeConverter<ActiveCaloriesBurnedRecord, HCEnergy>() {
    ...
    override fun ActiveCaloriesBurnedRecord.getTime() = endTime
