...
import com.kieronquinn.app.smartspacer.plugin.googlehome.ui.screens.complication.GoogleHomeComplicationConfigurationViewModel.State
...
class GoogleHomeComplicationConfigurationFragment: BaseSettingsFragment(), BackAvailable {
    ...
    private val viewModel by viewModel<GoogleHomeComplicationConfigurationViewModel>()
    ...
    private fun State.Loaded.loadItems(): List<BaseSettingsItem> {
        return listOf(
            ...
            GenericSettingsItem.SwitchSetting(
                showSubtitle,
                getString(R.string.complication_configuration_show_subtitle_title),
                getText(R.string.complication_configuration_show_subtitle_content),
                null,
                onChanged = viewModel::onShowSubtitleChanged
            ),
