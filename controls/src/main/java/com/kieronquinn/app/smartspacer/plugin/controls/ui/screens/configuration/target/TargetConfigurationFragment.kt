...
import com.kieronquinn.app.smartspacer.plugin.controls.ui.screens.configuration.target.TargetConfigurationViewModel.State
import com.kieronquinn.app.smartspacer.plugin.controls.ui.screens.configuration.target.subtitle.CustomSubtitleBottomSheetFragment.Companion.setupCustomSubtitleResultListener
...
class TargetConfigurationFragment: BaseSettingsFragment(), BackAvailable, ProvidesOverflow {

    companion object {
        private const val REQUEST_KEY_ICON = "target_icon"
    }
    ...
    private fun setupListeners() {
        ...
        setupCustomSubtitleResultListener {
            viewModel.onCustomSubtitleChanged(it)
        }
    }
    ...
    private fun ControlsTemplate<ControlTemplate>.getTemplateSpecificOptions(
        ...
        data: ControlsTarget.TargetData,
        ...
        return listOf(
            ...
            Setting(
                getString(R.string.configuration_custom_subtitle_title),
                data.customSubtitle
                    ?: getText(R.string.configuration_custom_subtitle_content),
                ContextCompat.getDrawable(requireContext(), R.drawable.ic_configuration_custom_title),
                onClick = viewModel::onCustomSubtitleClicked
            )
        )
    }
