...
open class MonetSwitch: FrameLayout, MonetColorsChangedListener {
    ...
    private val layout by lazy {
        layoutInflater.inflate(com.kieronquinn.app.shared.R.layout.view_monet_switch, this, false)
    }

    private val label by lazy {
        layout.findViewById<TextView>(com.kieronquinn.app.shared.R.id.view_monet_switch_text)
    }

    private val switch by lazy {
        layout.findViewById<MaterialSwitch>(com.kieronquinn.app.shared.R.id.view_monet_switch_switch)
    }

    private val root by lazy {
        layout.findViewById<LinearLayout>(com.kieronquinn.app.shared.R.id.view_monet_switch_root)
    }
