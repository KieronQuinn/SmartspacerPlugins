package com.kieronquinn.app.smartspacer.plugin.shared.utils.gson
...
/**
 *  https://gist.github.com/felix-kaestner/c8aa716447a86df87d8a88f02e1fe94f
 */
class BitmapTypeAdapter: JsonSerializer<Bitmap?>, JsonDeserializer<Bitmap?> {
    ...
    override fun serialize(src: Bitmap?, typeOfSrc: Type?, context: JsonSerializationContext?): JsonElement {
        ...
        return JsonPrimitive(Base64.encodeToString(byteArrayOutputStream.toByteArray(), Base64.NO_WRAP))
    }
