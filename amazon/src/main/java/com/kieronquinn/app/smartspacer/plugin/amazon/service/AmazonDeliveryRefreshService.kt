...
class AmazonDeliveryRefreshService: LifecycleService() {

    companion object {
        fun start(context: Context) {
            context.startService(Intent(context, AmazonDeliveryRefreshService::class.java))
        }
    }
    ...
    private val headlessOrdersWebView by lazy {
    ...
    override fun onCreate() {
        super.onCreate()
        startForegroundCompat(NotificationId.DELIVERY_REFRESH, createNotification())
        whenCreated {
            amazonRepository.updateDeliveriesAndShowNotificationIfNeeded(
                headlessOrdersWebView,
                headlessOrderDetailsWebView
            )
    ...
    private fun createNotification(): Notification {
        return notifications.showNotification(
            NotificationId.DELIVERY_REFRESH,
            ...
            it.setContentIntent(
                PendingIntent.getActivity(
                    this,
                    NotificationId.DELIVERY_REFRESH.ordinal,
                    notificationIntent,
